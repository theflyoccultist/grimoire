...
- [Programming Languages 🖥️](programming/README.md)
  ...
  - [Haskell 🧙](programming/haskell/README.md)
    ...
    - [Introduction to Functions](programming/haskell/04-functions.md)
    - [Function Definition with Patterns](programming/haskell/05-functions-patterns.md)
    - [Function Definition with Guards](programming/haskell/06-functions-guards.md)
    - [Local Definitions](programming/haskell/07-functions-local.md)
    - [Function Currying](programming/haskell/08-functions-currying.md)
